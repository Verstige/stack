    ...
    <form wire:submit='submit' class="flex flex-col pb-32">
        ...
        <div class="flex flex-col gap-2 py-4">
            ...
            <div class="pt-6">
                ...
                @if ($application->build_pack === 'dockerimage')
                    <x-forms.input
                        helper="You can add custom docker run options that will be used when your container is started.<br>Note: Not all options are supported, as they could mess up Stack's automation and could cause bad experience for users.<br><br>Check the <a class='underline dark:text-white' href='https://coolify.io/docs/knowledge-base/docker/custom-commands'>docs.</a>"
                ...
                <div x-data="{ showRaw: true }">
                    ...
                    <div class="w-full sm:w-96">
                        ...
                        {{-- <x-forms.checkbox label="Readonly labels"
                            helper="Labels are readonly by default. Readonly means that edits you do to the labels could be lost and Stack will autogenerate the labels for you. If you want to edit the labels directly, disable this option. <br><br>Be careful, it could break the proxy configuration after you restart the container as Stack will now NOT autogenerate the labels for you (ofc you can always reset the labels to the coolify defaults manually)."
            ...
            @if ($buildPack !== 'dockercompose')
                ...
                @can('update', $application)
                    <x-modal-confirmation title="Confirm Labels Reset to Stack Defaults?"
